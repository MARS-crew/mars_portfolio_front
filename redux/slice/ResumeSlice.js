...
export const ResumeSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(getResumesAsync.fulfilled, (state, action) => {
            state.list = action.payload;
        })
    },
});
...
export const { setResumeList, } = ResumeSlice.actions

export const getResumeListSelector = (state: RootState) => state.resumes.list;
