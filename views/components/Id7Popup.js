          ...
          <View style={styles.contentView}>
            <View style={styles.imageView}>
              ...
              <Progress.Bar
                ...
                borderColor="#ffffff"
                borderRadius={10}></Progress.Bar>
              <ImageBackground
                source={require('../../assets/images/blackBuble.png')}
                style={[
                  styles.bubble,
                  {
                    left: calculateLeftValue(rate),
            ...
            <Title>
              2015년 공표된 JavaScript의 최신 표준 명세이며, 줄여서 ES6라고도
              부릅니다. 기존 자바스크립트에서 문제점이라 지적 되었던 것들, 혹은
              필요하다고 생각되는 문법이 많이 추가되어 더 편리한 언어로
              거듭되었습니다.
              {'\n'}
              {'\n'}
              {'\n'}
              구형 브라우저에서는 바로 사용할 수 없으며, 구형 코드로 변환하는
              과정이 필요합니다.NodeJS나 Chromium App, Electron 등에서는 바로
              사용할 수 있습니다.
            </Title>
          </View>
        )}
